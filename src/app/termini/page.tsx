...
export const metadata = { title: "Termini di servizio — Mentathlos" };
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-4 rounded-md border border-dashed border-improving/40 bg-improving/10 p-4 text-sm text-improving">
        ...
        competente del soggetto che opera Mentathlos. Il resto di questo documento descrive accuratamente le
        condizioni d&apos;uso del software oggi.
      </div>

      <section className="mt-8 space-y-3 text-sm text-foreground/90">
        <h2 className="text-base font-semibold">1. Cos&apos;è Mentathlos</h2>
        <p>
          Mentathlos è un software che aiuta allenatori sportivi a gestire atleti, squadre, allenamenti, calendario,
        ...
        <p>
          Per usare Mentathlos è necessario creare un account con nome, email e password. Sei responsabile della
        ...
        <p>
          Gli atleti e le squadre che gestisci non sono utenti registrati di Mentathlos: sei tu, come coach, a
        ...
        <h2 className="pt-3 text-base font-semibold">5. Piani e pagamenti del tuo account Mentathlos</h2>
        <p>
          Mentathlos offre un piano gratuito e piani a pagamento con funzionalità aggiuntive. I prezzi mostrati nella
        ...
        <p>
          ...
          secondo i termini di Stripe; Mentathlos non tocca né conserva mai i dati della carta. Per i pagamenti
          registrati manualmente, sei tu a confermarne la ricezione: Mentathlos si limita a tenerne traccia.
        </p>

        <h2 className="pt-3 text-base font-semibold">7. Uso consentito</h2>
        <p>
          Ti impegni a non usare Mentathlos per scopi illeciti, per inserire dati di terzi senza titolo legittimo, o
        ...
        <p>
          Puoi smettere di usare Mentathlos e richiedere la cancellazione del tuo account in qualsiasi momento. Ci
